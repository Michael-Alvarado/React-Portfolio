...
const Resume = () => {
    return (
        <section id="resume" className="mt-20 pb-10" >
            <h2 className="font-itim text-center text-emerald font-semibold text-4xl p-4">
                My Resume
            </h2>
            <div className="justify-items-center gap-8 text-center">
                ...
                <a href={pdf} rel='noreferrer' target='_blank'>
                    <button className='rounded-sm bg-picton-blue mt-4 py-3 px-9 gap-2 text-lg font-semibold text-charcoal hover:text-magnolia hover:bg-emerald transition duration-500' style={{display: 'inline-flex'}}>
